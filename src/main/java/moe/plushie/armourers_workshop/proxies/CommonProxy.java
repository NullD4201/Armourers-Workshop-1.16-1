...
// TODO: 2022-01-22 FML EventHandler
...
public class CommonProxy implements ILibraryCallback {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        // Set API stuff!
        ObfuscationReflectionHelper.setPrivateValue(ArmourersWorkshopApi.class, null, SkinNBTUtils.INSTANCE, "skinNBTUtils");
    ...
    public void receivedAdminPanelCommand(PlayerEntity player, AdminPanelCommand command) {
