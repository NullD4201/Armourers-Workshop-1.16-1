...
@Mod.EventBusSubscriber(modid = LibModInfo.ID, value = { Dist.CLIENT })
@OnlyIn(Dist.CLIENT)
public class ClientProxy extends CommonProxy implements IBakedSkinReceiver {
    ...
    public void initRenderers() {
        ...
        ClientRegistry.bindTileEntityRenderer(TileEntityArmourer.class, new RenderBlockArmourer());
        ...
        Minecraft.getInstance().getItemColors().register(new ItemColour(), ModItems.PAINT_BRUSH);
        Minecraft.getInstance().getItemColors().register(new ItemColour(), ModItems.PAINT_ROLLER);
        Minecraft.getInstance().getItemColors().register(new ItemColour(), ModItems.COLOUR_PICKER);
        Minecraft.getInstance().getItemColors().register(new ItemColour(), ModItems.DYE_BOTTLE);
        Minecraft.getInstance().getItemColors().register(new ItemColour(), ModItems.HUE_TOOL);
        Minecraft.getInstance().getItemColors().register(new ItemColour(), ModItems.SOAP);
        Minecraft.getInstance().getItemColors().register(new ItemColour(), ModItems.GIFT_SACK);

        Minecraft.getInstance().getBlockColors().register(new BlockColour(), ModBlocks.SKIN_CUBE);
        Minecraft.getInstance().getBlockColors().register(new BlockColour(), ModBlocks.SKIN_CUBE_GLASS);
        Minecraft.getInstance().getBlockColors().register(new BlockColour(), ModBlocks.SKIN_CUBE_GLOWING);
        Minecraft.getInstance().getBlockColors().register(new BlockColour(), ModBlocks.SKIN_CUBE_GLASS_GLOWING);
        Minecraft.getInstance().getBlockColors().register(new BlockColour(), ModBlocks.COLOUR_MIXER);
        ...
        FMLCommonHandler.instance().registerCrashCallable(new ICrashCallable() {
            ...
            public String call() throws Exception {
                ...
                for (PlayerRenderer playerRender : Minecraft.getInstance().getRenderManager().getSkinMap().values()) {
                    ...
                    Object object = ObfuscationReflectionHelper.getPrivateValue(LivingRenderer.class, playerRender, "field_177097_h", "layerRenderers");
                    if (object != null) {
    ...
    private void enableValentinesClouds() {
        ...
        try {
            Object o = ObfuscationReflectionHelper.getPrivateValue(WorldRenderer.class, null, "CLOUDS_TEXTURES", "field_110925_j");
            Field f = ObfuscationReflectionHelper.findField(ResourceLocation.class, "namespace", "field_110626_a");
