...
public class LibModInfo {
    public static final String ID = ArmourersWorkshop.MOD_ID;
    ...
    //public static final String DEPENDENCIES = "required-after:forge@[14.23.3.2694,);after:galacticraftcore;"; TODO
